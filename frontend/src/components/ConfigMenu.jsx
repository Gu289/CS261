            ...
            <div className="flex flex-col text-xl items-center justify-center bg-primary rounded-lg shadow-md p-3">
                <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                        <input type="checkbox" checked={leftTurn} onChange={handleLeftTurn} className="sr-only peer" />
                ...
                <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <select className="cursor-pointer text-sm rounded-lg p-3 dark:bg-gray-600 dark:placeholder-gray-400 dark:text-white mb-2" value={lanes} onChange={handleLanes}>
                        <option value={1} disabled selected>Choose number of lanes</option>
